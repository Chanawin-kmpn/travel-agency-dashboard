...
export const loader = async ({ params }: LoaderFunctionArgs) => {
	...
	//ตอนนี้คือต้องรอทั้งสองอันในการ Fetch ซึ่งไม่จำเป็นที่ต้องรอพร้อมกัน
	...
	return (
		<main className="travel-detail wrapper">
			...
			<section className="container wrapper-md">
							...
							<ul>
								{dayplan.activities.map((activity, index: number) => (
									<li key={index}>
										...
										<p className="flex-gorw">{activity.description}</p>
									</li>
								))}
							</ul>
						</li>
				...
				{visiTimeAndWeatherInfo.map((section) => (
